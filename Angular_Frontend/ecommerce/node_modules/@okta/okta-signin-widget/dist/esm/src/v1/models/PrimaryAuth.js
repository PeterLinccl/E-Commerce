...
var PrimaryAuthModel = BaseLoginModel.extend({
  ...
  save: function () {
    ...
    if (this.appState.get('isUnauthenticated')) {
      const authClient = this.appState.settings.getAuthClient(); // bootstrapped with stateToken
  ...
  doPrimaryAuth: function (authClient, signInArgs, func) {
    ...
    const typingPatternEnabled = this.settings.get('features.trackTypingPattern'); // Add the custom header for fingerprint, typing pattern if needed, and then remove it afterwards
...
//# sourceMappingURL=PrimaryAuth.js.map
