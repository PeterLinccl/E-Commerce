...
const TransactionManager = createTransactionManager(); // Start with OAuth as base

const OktaAuthOAuth = createOktaAuthOAuth(StorageManager, OptionsConstructor, TransactionManager); // Mixin Authn support
