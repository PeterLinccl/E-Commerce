...
var IDPDiscoveryController = PrimaryAuthController.extend({
  ...
  constructor: function (options) {
    ...
    const stateToken = lastAuthResponse && (lastAuthResponse === null || lastAuthResponse === void 0 ? void 0 : lastAuthResponse.stateToken); //Update requestContext with last stateToken, if the context was stateToken and not a fromUri
  ...
  doPrimaryAuth: function () {
    if (this.settings.get('features.passwordlessAuth')) {
      ...
      this.addModelListeners(primaryAuthModel); // Make the primary auth request
